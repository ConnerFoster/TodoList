...
document.addEventListener("DOMContentLoaded", _uiDefault.default.loadHome()); //let thisTask = new Task("Clean", new Date(2022, 11, 23));
 //console.log(thisTask);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./task":"8mW4a","./UI":"d3pWC","./projects":"klhV6","./todolist":"1iboQ","./styles.css":"lW6qc"}],"gkKU3":[function(require,module,exports) {
...
var _task = require("./task");
var _taskDefault = parcelHelpers.interopDefault(_task);
const myList = new _todolistDefault.default();
...
class UI {
    ...
    static showProjectInput() {
        ...
        document.getElementById("submit-project").addEventListener("click", ()=>{
            ...
            if (userInput.length >= 1) {
                myList.addProject(new _projectsDefault.default(userInput));
                UI.displayProjects();
                UI.cancelProject();
            } else {
    ...
    static cancelProject() {
        addProjectDiv.innerHTML = "<button id='add-project-button' class='add'>+ Add Project</button>";
        UI.setupProjectBtns();
    }
    ...
    static setupProjectBtns() {
        ...
        const addProjectBtn1 = document.getElementById("add-project-button");
        ...
        addProjectBtn1.addEventListener("click", ()=>{
            UI.showProjectInput();
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./todolist":"1iboQ","./projects":"klhV6","./task":"8mW4a"}],"1iboQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _projects = require("./projects");
var _projectsDefault = parcelHelpers.interopDefault(_projects);
class TodoList {
    ...
    addToInbox(task) {
        ...
        console.log(lastDay);
        if (task.dueDate.toDateString() === todaysDate.toDateString()) this.today.push(task);
        if (task.dueDate >= todaysDate && task.dueDate <= lastDay) this.week.push(task);
    }
    getInbox() {
        return this.inbox;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./projects":"klhV6"}],"klhV6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Project {
    constructor(name){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}]},["6IXwR","bNKaB"], "bNKaB", "parcelRequire78f8")
